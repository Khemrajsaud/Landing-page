...
//       className="top-0 z-50 bg-white shadow-md"
//     >
     
//       <div className="max-w-7xl mx-auto px-5 flex items-center justify-between">
//         {/* Logo */}
//         <img src={logo} alt="Logo" className=" w-20 md:w-30" />
...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      animate={{ y: 0, opacity: 1 }}
      transition={{ duration: 0.6 }}
      className="fixed md:static top-0 left-0 w-full z-50 bg-white shadow-md"
    >

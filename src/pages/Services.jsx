...
import { 
  Monitor, Smartphone, Cpu, Users, Layers, 
  Code2, School, BookOpen, ArrowRight, GraduationCap 
} from 'lucide-react';
  ...
  const softwareServices = [
    {
      ...
      description: "Modern, responsive web applications built with React and Node.js.",
    ...
    },
    {
      ...
      description: "Machine learning solutions to automate tasks and analyze data.",
      icon: <Cpu className="w-6 h-6" />,
    },
    {
      title: "Technical Consulting",
      description: "Guidance on technology decisions and software architecture.",
  ...
  const academyServices = [
    {
      ...
      description: "Hands-on training in industry-standard technologies for aspiring engineers.",
      icon: <Code2 className="w-5 h-5" />,
    },
    {
      title: "School Programs",
      description: "Customized technology curriculums for schools and colleges across Nepal.",
      icon: <School className="w-5 h-5" />,
    },
    {
      title: "IT Fundamentals",
      description: "Core concepts for beginners to build a strong foundation in the tech industry.",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-6 md:space-y-8 text-center lg:text-left">
            ...
            <p className="max-w-md mx-auto lg:mx-0 text-lg md:text-xl text-slate-500 font-medium leading-relaxed">
              We deliver professional software development and technical education, helping businesses grow.
            </p>
      ...
      <section className="py-20 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {softwareServices.map((item, i) => (
            <div key={i} className="group p-8 md:p-10 rounded-[2.5rem] bg-slate-50/50 border border-slate-100 transition-all duration-500 hover:bg-white hover:shadow-2xl hover:-translate-y-2">
      ...
      <section className="py-20 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
          {academyServices.map((item, i) => (
            <div key={i} className="group relative p-10 rounded-[3rem] bg-white border border-slate-100 transition-all duration-500 hover:bg-black cursor-pointer hover:shadow-2xl hover:-translate-y-2">
        ...
        <div className="relative overflow-hidden bg-black rounded-[3rem] p-10 md:p-16 lg:p-20 flex flex-col lg:flex-row items-center justify-between gap-10 text-center lg:text-left group">
            ...
            <div className="relative z-10 max-w-2xl">
                <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 tracking-tight">
                    Need a bespoke <br className="hidden md:block"/> technical strategy?
                </h2>
                <p className="text-slate-400 text-base md:text-lg max-w-lg mx-auto lg:mx-0">
                    Our senior engineers are ready to analyze your existing stack and propose high-impact performance optimizations.
                </p>
            </div>

            <div className="relative z-10 shrink-0">
                <button className="flex items-center gap-3 bg-white text-black px-10 py-5 rounded-full font-black text-[10px] tracking-[0.2em] uppercase hover:bg-slate-200 transition-all active:scale-95 shadow-xl shadow-white/5">
                    Get Consulted
